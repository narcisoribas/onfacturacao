                            ...
                            <div className="row">
                                    ...
                                    <div className="col-md-3">
                                        <figure className="card card-product">
                                            ...
                                            <a className="btn-overlay" href="#"><i class="fa fa-search-plus"></i> Quick view</a>
                                            </div>
                                            <figcaption className="info-wrap">
                                    ...
                                    <div className="col-md-3">
                                        <figure className="card card-product">
                                            ...
                                            <figcaption className="info-wrap">
                                                ...
                                                <div className="action-wrap">
                                                    <a href="#" className="btn btn-primary btn-sm float-right"> <i class="fa fa-cart-plus"></i> Add </a>
                                                    <div className="price-wrap h5">
                                                        <span className="price-new">$280</span>
